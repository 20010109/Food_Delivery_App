...
function StoreOwnerEditStoreModal({
  ...
  const uploadCard =
    "cursor-pointer rounded-xl border border-dashed border-gray-700 bg-gray-800 px-4 py-4 text-center transition hover:border-red-500 hover:bg-gray-750";

  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm px-4 py-6">
      <div className="w-full max-w-2xl overflow-hidden rounded-3xl border border-gray-800 bg-gray-900 text-white shadow-2xl">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-400">
                Update your restaurant branding and details.
              </p>
            </div>

            <button
              onClick={onClose}
              className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-800 text-gray-300 hover:bg-red-600 hover:text-white"
            >
              ✕
            </button>
          </div>
        ...
        {/* BODY */}
        <div className="max-h-[85vh] overflow-y-auto px-8 py-7 space-y-6">
          ...
          <div>
            ...
            <div
              className="relative h-44 w-full overflow-hidden rounded-2xl border border-gray-800 bg-gray-800 bg-cover bg-center"
              style={{
            ...
            >
              ...
              <div className="absolute -bottom-7 left-6 h-16 w-16 overflow-hidden rounded-full border-4 border-gray-900 bg-gray-800">
                {form.profile_image ? (
                  <img
