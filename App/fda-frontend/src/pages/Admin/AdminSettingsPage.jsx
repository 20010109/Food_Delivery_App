              ...
              <form onSubmit={handlePasswordChange} className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-red-200"
                ...
                {passwordMsg && (
                  <p className="text-xs text-green-600">{passwordMsg}</p>
                )}

                <button
                  type="submit"
                  disabled={passwordLoading}
                  className="w-full bg-red-600 hover:bg-red-700 text-white text-sm font-medium py-2 rounded-xl transition disabled:opacity-60"
                >
            ...
            <section className="bg-white rounded-2xl shadow-sm p-6 space-y-4">
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="flex items-center gap-2 text-sm text-red-500 hover:text-red-700 transition font-medium pt-2"
                >
